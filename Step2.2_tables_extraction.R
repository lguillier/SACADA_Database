...
dt <- data.frame(Kinetic_key = c(Table_Batejat2020$Kinetic_key,
                                 Table_Behzadinasab2020_S$Kinetic_key,
                                 Table_Chin2020_A$Kinetic_key, 
                                 Table_Chin2020_B$Kinetic_key,
                                 Table_Dai2020_SuppTable$Kinetic_key,
                                 Table_Fukuta2021_1$Kinetic_key,
                                 Table_Hulst2019_3$Kinetic_key,
                                 Table_Kasloff2020_2$Kinetic_key,
                                 Table_Leclercq2014_1$Kinetic_key,
                                 Table_Lee2020$Kinetic_key,
                                 Table_Malenovska2020_2$Kinetic_key,
                                 Table_Marugano2021$Kinetic_key,
                                 Table_OCLC2020$Kinetic_key,
                                 Table_Pastorino2020$Kinetic_key,
                                 Table_Rabenau2005_1$Kinetic_key,
                                 Table_Ronca2021_2$Kinetic_key,
                                 Table_Saknimit1988_3$Kinetic_key),
                 ...
                 y_variable = c(rep("logTCID50_ml", nrow(Table_Batejat2020)),
                                ...
                                rep("PFU_2cm2", nrow(Table_Ronca2021_2)),
